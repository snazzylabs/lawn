...
// Design 10c: Protest Poster - Typographic impact
// Massive lawn brand, clear product statement, bold comparison

export default function Homepage10c() {
  return (
    <div className="min-h-screen bg-[#f0f0e8] text-[#1a1a1a]">
      ...
      <nav className="px-6 py-4 flex justify-between items-center">
        <div className="flex items-center gap-4">
          ...
          <span className="text-xs text-[#888] hidden sm:inline border-l border-[#ccc] pl-4">video review</span>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="max-w-2xl mt-8">
            <p className="text-2xl sm:text-3xl font-bold leading-tight">
              ...
              <span className="text-[#2d5a2d]"> Click any frame to leave a comment.</span>
            </p>
          </div>
      ...
      <section className="px-6 py-16 border-b-2 border-[#1a1a1a]">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="mt-4 text-[#888]">— lawn creator</p>
        </div>
      </section>
